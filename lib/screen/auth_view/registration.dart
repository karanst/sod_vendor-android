...
class VendorRegisteration extends StatefulWidget {
  ...
  const VendorRegisteration({Key? key, required this.role, this.lat, this.long})
      : super(key: key);
...
class _VendorRegisterationState extends State<VendorRegisteration> {
  ...
  getLocation() {
    ...
    location.getLoc();
    print(
        "this is current location --->>> ${addressController.text.toString()}");
  }
      ...
      child: InkWell(
        ...
        child: Center(
          child: Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(15),
              child: fssaiImage != null
                  ? Image.file(fssaiImage!, fit: BoxFit.cover)
                  : Column(
                      children: [
                        Center(
                            child: Icon(Icons.upload_file_outlined, size: 60)),
        ...
        child: Center(
          child: Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(15),
              child: gstImage != null
                  ? Image.file(gstImage!, fit: BoxFit.cover)
                  : Column(
                children: [
                  Center(
                      child: Icon(Icons.upload_file_outlined, size: 60)),
  ...
  submitRequest() async {
    ...
    if (type == "2" || type == "3" || type == "4") {
      ...
      if (rcImageBack != null) {
        request.files.add(await http.MultipartFile.fromPath(
            'rc_book_back', rcImageBack!.path));
      }
      if (drivingImageBack != null) {
        request.files.add(await http.MultipartFile.fromPath(
            'driving_license_back', drivingImageBack!.path));
      }
    }
    ...
    if (type == "5") {
      request.fields.addAll({
        'city_id': '${categoryValue.toString()}',
        'company_name':
            roleUser ? '${companyController.text.toString()}' : 'freelancer',
    ...
    if (aadharImageBack != null) {
      request.files.add(await http.MultipartFile.fromPath(
          'adhar_back', aadharImageBack!.path));
    }
    if (panImage != null) {
      request.files
    ...
    if (fssaiImage != null) {
      request.files.add(
          await http.MultipartFile.fromPath('fssai_image', fssaiImage!.path));
    }
    if (gstImage != null) {
      request.files.add(
          await http.MultipartFile.fromPath('gst_image', gstImage!.path));
    }
...
//   }
  ...
  _getCities() async {
    var uri =
        Uri.parse('https://developmentalphawizz.com/SOD_New/api/get_cities');
  ...
  var deliveryType = ['Ride Only', 'Delivery Only', 'Both'];
            ...
            child: TextFormField(
                ...
                decoration: InputDecoration(
                    suffixIcon: IconButton(
                        ...
                        icon: Icon(Icons.location_searching, color: AppColor().colorPrimary(),)),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(15),
                          border:
                              Border.all(color: AppColor().colorSecondary())),
                      child: DropdownButton(
                        // Initial Value
                        value: accTypeValue,
                        underline: Container(),
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  'Vehicle No.',
                                  style:
                                      TextStyle(color: AppColor().colorBg1()),
                                ),
                              ),
                              SizedBox(
                                height: 10,
                      ...
                      onTap: () {
                        ...
                        if (!RegExp(
                            ...
                            .hasMatch(passwordController.text.toString())) {
                              ...
                              msg: 'Password must be at least 8 characters long, contain at least 1 uppercase, 1 lowercase , 1 number & 1 special character'
                          );
                          setState(() {
                            isLoading = false;
                          });
                          ...
                          if (isUpi == false) {
                            ...
                            if (accountNoController.text.isNotEmpty &&
                              ...
                              if (accountNoController.text ==
                                  confmAccountNumController.text) {
                                submitRequest();
                              } else {
                                setState(() {
                                  isLoading = false;
